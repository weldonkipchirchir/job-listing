      ...
      <main className="padding h">
        <div className="mx-auto flex justify-center w-full max-sm:w-full">
          <div className="w-full">
            <h2 className="font-bold text-4xl my-7 max-sm:text-3xl max-xs:text-2xl">Available Jobs</h2>
            <SearchInput placeholder="Search for products..." onSearch={handleSearch} />
            <div className="mt-6">
              <ul className="">
                {jobs.map((job, index) => (
                  <NavLink key={index} to="/job-details">
                    <li className="flex justify-between my-8 max-sm:items-center max-sm:flex-col">
                      ...
                      <div className="flex items-center">
                        <p className="text-xl font-medium">{job.salaryLow}</p>
                        <span className="mx-1 font-medium">-</span>
                        <p className="text-xl font-medium">{job.salaryHigh}</p>
                      </div>
                    </li>
                  </NavLink>
                ))}

...
export function Signup() {
  ...
  return (
    <div className="w-full max-w-md p-4 mx-auto bg-white rounded-none shadow-lg md:rounded-2xl md:p-8 dark:bg-black shadow-slate-500">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="pb-0 mt-6">
            <p className="text-lg">
            Have an account? 
            <NavLink to='/sign-in' className='underline text-primary'> Sign In</NavLink>
            </p>
        </div>
